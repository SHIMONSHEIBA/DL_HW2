...
local output2 = conv2:forward(output1)
print(output2:size())
...
local output3 = conv3:forward(output2)
print(output3:size())
...
print('4th layer: ')
print(conv4)
print('4th layer output: ')
local output4 = conv4:forward(output3)
print(output4:size())
...
print('5th layer: ')
print(conv5)
print('5th layer output: ')
local output5 = conv5:forward(output4)
print(output5:size())
...
print('6th layer: ')
print(conv6)
print('6th layer output: ')
local output6 = conv6:forward(output5)
print(output6:size())
...
print('7th layer: ')
print(conv7)
print('7th layer output: ')
local output7 = conv7:forward(output6)
print(output7:size())
...
print('8th layer: ')
print(conv8)
print('8th layer output: ')
local output8 = conv8:forward(output7)
print(output8:size())
...
print('9th layer: ')
print(conv9)
print('9th layer output: ')
local output9 = conv9:forward(output8)
print(output9:size())
