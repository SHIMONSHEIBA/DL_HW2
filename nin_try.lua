...
model:add(cudnn.SpatialConvolution(64,96,5,5,1,1,2,2))
model:add(cudnn.SpatialBatchNormalization(96))--,1e-3))
model:add(nn.ReLU(true))
model:add(cudnn.SpatialConvolution(96,112,1,1))
model:add(cudnn.SpatialBatchNormalization(112))--,1e-3))
model:add(nn.ReLU(true))
model:add(cudnn.SpatialConvolution(112,96,1,1))
model:add(cudnn.SpatialBatchNormalization(96))--,1e-3))
model:add(nn.ReLU(true))
model:add(cudnn.SpatialAveragePooling(3,3,2,2):ceil())
model:add(nn.Dropout())
model:add(cudnn.SpatialConvolution(96,64,3,3,1,1,1,1))
model:add(cudnn.SpatialBatchNormalization(64))--,1e-3))
model:add(nn.ReLU(true))
