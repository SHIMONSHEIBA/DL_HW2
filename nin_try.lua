...
model:add(cudnn.SpatialBatchNormalization(24))--,1e-3))
model:add(nn.ReLU(true))
model:add(cudnn.SpatialConvolution(24,20,1,1))
model:add(cudnn.SpatialBatchNormalization(20))--,1e-3))
model:add(nn.ReLU(true))
model:add(cudnn.SpatialConvolution(20,#classes,1,1))
