...
model:add(cudnn.SpatialConvolution(3, 162, 5, 5, 1, 1, 2, 2)) -- 3 input image channel, 32 output channels, 5x5 convolution kernel
model:add(cudnn.SpatialBatchNormalization(162))    --Batch normalization will provide quicker convergence
