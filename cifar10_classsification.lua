...
model:add(cudnn.SpatialConvolution(3, 120, 5, 5, 1, 1, 2, 2)) -- 3 input image channel, 32 output channels, 5x5 convolution kernel
model:add(cudnn.SpatialBatchNormalization(120))    --Batch normalization will provide quicker convergence
