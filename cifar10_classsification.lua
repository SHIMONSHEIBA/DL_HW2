...
model:add(cudnn.SpatialConvolution(3, 128, 5, 5,1,1,2,2)) -- 3 input image channel, 32 output channels, 5x5 convolution kernel
model:add(cudnn.SpatialBatchNormalization(128))    --Batch normalization will provide quicker convergence
...
model:add(cudnn.SpatialConvolution(128, 32, 5, 5,1,1,2,2))
